  ...
  return (
    <div className="pricing-container">
      ...
      <Navbar8
        ...
        action1={
          <Fragment>
            <span className="pricing-text109">Pricing</span>
          </Fragment>
        }
        action2={
          <Fragment>
            <span className="pricing-text110">Get a qoute</span>
          </Fragment>
        }
        link1Url="/"
        link3Url="/contact"
        ...
        page4Description={
          <Fragment>
            <span className="pricing-text114">
      ...
      <Pricing1421
        text={
          <Fragment>
            <span className="pricing-text115">most popular</span>
          </Fragment>
        }
        plan1={
          <Fragment>
            <span className="pricing-text116">starter site</span>
          </Fragment>
        }
        plan2={
          <Fragment>
            <span className="pricing-text117">Business site</span>
          </Fragment>
        }
        plan3={
          <Fragment>
            <span className="pricing-text118">Complete Business Website</span>
          </Fragment>
        }
        plan11={
          <Fragment>
            <span className="pricing-text119">Basic plan</span>
          </Fragment>
        }
        plan21={
          <Fragment>
            <span className="pricing-text120">Business plan</span>
          </Fragment>
        }
        plan31={
          <Fragment>
            <span className="pricing-text121">Enterprise plan</span>
          </Fragment>
        }
        content1={
          <Fragment>
        ...
        content2={
          <Fragment>
            <span className="pricing-text123">
        ...
        heading1={
          <Fragment>
            <span className="pricing-text124">Pricing plan</span>
          </Fragment>
        }
        plan1Price={
          <Fragment>
            <span className="pricing-text125">R2799</span>
          </Fragment>
        }
        plan2Price={
          <Fragment>
            <span className="pricing-text126">R3499</span>
          </Fragment>
        }
        plan3Price={
          <Fragment>
            <span className="pricing-text127">R5499</span>
          </Fragment>
        }
        plan1Action={
          <Fragment>
            <span className="pricing-text128">Get Started</span>
          </Fragment>
        }
        plan1Price1={
          <Fragment>
            <span className="pricing-text129">$200/yr</span>
          </Fragment>
        }
        plan1Yearly={
          <Fragment>
            <span className="pricing-text130">R250/pm Hosting</span>
          </Fragment>
        }
        plan2Action={
          <Fragment>
            <span className="pricing-text131">Get Started</span>
          </Fragment>
        }
        plan2Price1={
          <Fragment>
            <span className="pricing-text132">$299/yr</span>
          </Fragment>
        }
        plan2Yearly={
          <Fragment>
            <span className="pricing-text133">R250/pm Hosting</span>
          </Fragment>
        }
        plan3Action={
          <Fragment>
            <span className="pricing-text134">Get Started</span>
          </Fragment>
        }
        plan3Price1={
          <Fragment>
            <span className="pricing-text135">$499/yr</span>
          </Fragment>
        }
        plan3Yearly={
          <Fragment>
            <span className="pricing-text136">R250/pm Hosting</span>
          </Fragment>
        }
        plan1Action1={
          <Fragment>
            <span className="pricing-text137">Get started</span>
          </Fragment>
        }
        plan1Yearly1={
          <Fragment>
            <span className="pricing-text138">or $20 monthly</span>
          </Fragment>
        }
        plan2Action1={
          <Fragment>
            <span className="pricing-text139">Get started</span>
          </Fragment>
        }
        plan2Yearly1={
          <Fragment>
            <span className="pricing-text140">or $29 monthly</span>
          </Fragment>
        }
        plan3Action1={
          <Fragment>
            <span className="pricing-text141">Get started</span>
          </Fragment>
        }
        plan3Yearly1={
          <Fragment>
            <span className="pricing-text142">or $49 monthly</span>
          </Fragment>
        }
        plan1Feature1={
          <Fragment>
            <span className="pricing-text143">Standard Website Design</span>
          </Fragment>
        }
        plan1Feature2={
          <Fragment>
            <span className="pricing-text144">
        ...
        plan2Feature1={
          <Fragment>
            <span className="pricing-text145">Custom Website Design</span>
          </Fragment>
        }
        plan2Feature2={
          <Fragment>
            <span className="pricing-text146">Contact Form + WA button</span>
          </Fragment>
        }
        plan2Feature3={
          <Fragment>
            <span className="pricing-text147">mobile responsive </span>
          </Fragment>
        }
        plan2Feature4={
          <Fragment>
            <span className="pricing-text148">3 page website</span>
          </Fragment>
        }
        plan3Feature1={
          <Fragment>
            <span className="pricing-text149">premuim website design</span>
          </Fragment>
        }
        plan3Feature2={
          <Fragment>
            <span className="pricing-text150">contact form + WA button</span>
          </Fragment>
        }
        plan3Feature3={
          <Fragment>
            <span className="pricing-text151">layout cutomization</span>
          </Fragment>
        }
        plan3Feature4={
          <Fragment>
            <span className="pricing-text152">Blog Setup</span>
          </Fragment>
        }
        plan3Feature5={
          <Fragment>
            <span className="pricing-text153">5 page website </span>
          </Fragment>
        }
        ...
        plan1Feature31={
          <Fragment>
            <span className="pricing-text156">Feature text goes here</span>
          </Fragment>
        }
        plan1Feature32={
          <Fragment>
            <span className="pricing-text157">1 page website</span>
          </Fragment>
        }
        plan2Feature11={
          <Fragment>
        ...
        plan2Feature41={
          <Fragment>
            <span className="pricing-text161">Feature text goes here</span>
          </Fragment>
        }
        plan2Feature42={
          <Fragment>
            <span className="pricing-text162">google indexing setup</span>
          </Fragment>
        }
        plan3Feature11={
          <Fragment>
        ...
        plan3Feature41={
          <Fragment>
            <span className="pricing-text166">Feature text goes here</span>
          </Fragment>
        }
        plan3Feature42={
          <Fragment>
            <span className="pricing-text167">mobile responsive</span>
          </Fragment>
        }
        plan3Feature51={
          <Fragment>
            <span className="pricing-text168">Feature text goes here</span>
          </Fragment>
        }
        plan3Feature52={
          <Fragment>
            <span className="pricing-text169">google indexing setup</span>
          </Fragment>
        }
        plan1Feature321={
          <Fragment>
            <span className="pricing-text170">
        ...
        plan2Feature421={
          <Fragment>
            <span className="pricing-text171">1 content revision</span>
          </Fragment>
        }
        plan3Feature521={
          <Fragment>
            <span className="pricing-text172">2 content revisions</span>
          </Fragment>
        }
        plan2Feature4211={
          <Fragment>
        ...
        plan3Feature5211={
          <Fragment>
            <span className="pricing-text174">
        ...
        plan3Feature5212={
          <Fragment>
            <span className="pricing-text175">SEO setup </span>
          </Fragment>
        }
      ></Pricing1421>
      <Features16
        content1={
          <Fragment>
            <span className="pricing-text176">
        ...
        heading1={
          <Fragment>
            <span className="pricing-text177">Our Key Features</span>
          </Fragment>
        }
        feature1Title={
          <Fragment>
            <span className="pricing-text178">Custom Website Development</span>
          </Fragment>
        }
        feature2Title={
          <Fragment>
            <span className="pricing-text179">SEO Optimization</span>
          </Fragment>
        }
        feature3Title={
          <Fragment>
            <span className="pricing-text180">Responsive Web Design</span>
          </Fragment>
        }
        feature1Description={
          <Fragment>
      ...
      <FAQ14
        ...
        text3={
          <Fragment>
            <span className="pricing-text187">
              <span>
        ...
        content1={
          <Fragment>
            <span className="pricing-text192">
        ...
        heading1={
          <Fragment>
            <span className="pricing-text193">FAQs</span>
          </Fragment>
        }
        heading2={
          <Fragment>
            <span className="pricing-text194">Still have a question?</span>
          </Fragment>
        }
        faq1Question={
          <Fragment>
            <span className="pricing-text195">What services do you offer?</span>
          </Fragment>
        }
        faq2Question={
          <Fragment>
      ...
      <Footer4
        text={
          <Fragment>
            <span className="pricing-text200">
        ...
        link1={
          <Fragment>
            <span className="pricing-text201">Home</span>
          </Fragment>
        }
        link2={
          <Fragment>
            <span className="pricing-text202">Services</span>
          </Fragment>
        }
        link3={
          <Fragment>
            <span className="pricing-text203">About Us</span>
          </Fragment>
        }
        link4={
          <Fragment>
            <span className="pricing-text204">Contact Us</span>
          </Fragment>
        }
        termsLink={
          <Fragment>
            <span className="pricing-text205">Terms and Conditions</span>
          </Fragment>
        }
        cookiesLink={
          <Fragment>
            <span className="pricing-text206">Cookies Policy</span>
          </Fragment>
        }
        privacyLink={
          <Fragment>
            <span className="pricing-text207">Privacy Policy</span>
          </Fragment>
        }
