        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link11 ?? (
                <Fragment>
                  <span className="navbar8-text23">Pricing</span>
                </Fragment>
              )}
            </a>
            <a
          ...
          <div className="navbar8-buttons1">
            ...
            >
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text24">Get a qoute</span>
                  </Fragment>
                )}
              </span>
            </Link>
          ...
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              ...
              >
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text25">Pricing</span>
                  </Fragment>
                )}
              </Link>
                ...
                <div className="navbar8-menu-item3">
                  ...
                  <div className="navbar8-content3">
                    <span className="navbar8-page3 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text28">About Us</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
